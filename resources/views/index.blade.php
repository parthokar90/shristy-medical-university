...
<section id="mu-slider">
  ...
  <div class="mu-slider-single">
    ...
    <div class="mu-slider-content">
        ...
        <section id="mu-latest-courses" style="padding-top: 50px">
          <div class="container">
            <div class="row">
              <div class="col-lg-12 col-md-12">
                <div class="mu-title" style="padding-bottom: 30px">
                  <h2 style="color: white">Latest Courses</h2>
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-4" style="padding: 5px;">                                          
                              <div class="col-md-12" style="padding:0">
                               <a href="{{route('courseDetails',$item->id)}}"><img src="{{asset('backend/course/'.$item->image)}}" alt="img" style="height: 300px;width: 100%"></a>
                             </div>
                             <div class="col-md-12 bg-name-{{$key}} nameBorder">
                              <div class="col-md-12 courseName">
                                <a href="{{route('courseDetails',$item->id)}}">
                                  {{$item->course_name}}
                                </a>
                              </div>
                              <div class="col-md-12 courseDuration">
                                <sup>*</sup> {{$item->courseDuration}} Days
                              </div>                                                
                            </div>
                            <div class="col-md-12 bg-name-{{$key}}">
                              <div class="col-md-12 keyFeatures">Key features - </div>
                              <div class="col-md-12 courseContent" >
                                {{$item->keyFeatures}}
                              </div>
                              <div class="col-md-12 text-right ">
                               <a class="detailsLink" href="{{route('courseDetails',$item->id)}}">More details ...</a>
                             </div>
                           </div>
