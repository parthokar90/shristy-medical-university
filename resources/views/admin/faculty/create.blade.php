        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form role="form" method="POST" action="{{route('faculty.store')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                  <div class="row">
                    <div class="col-sm-4">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="textarea form-control" name="profileTitle" rows="3" placeholder="Enter profile Title"></textarea>
                      </div>
                    </div>
