        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form role="form" method="POST" action="{{route('module.store')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                  <div class="row">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input name="module_code" type="text" id="module_code" class="form-control" placeholder="Enter Module Code">
                      </div>
                    </div>
