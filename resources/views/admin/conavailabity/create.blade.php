        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin.home')}}">Home</a></li>
              <li class="breadcrumb-item active">Consultant Availability</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Consultant Availability Elements</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <form role="form" method="POST" action="{{route('consultantavailabitiy.store')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                  <div class="row">
                    <div class="col-sm-6">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input name="perPatientTime" type="text" id="perPatientTime" class="form-control" placeholder="Enter per Patient Time">
                    </div> 
                  </div>
                  <div class="row">
                    <div class="col-sm-4">
